"""Per-book checks for inferno/ — the euclid-rivals pattern.
...
cannot see any of the following.
  ...
  1 VERSE INTEGRITY, and it is the decisive check for this book, exactly
    as in boethius/. The Inferno is 4,720 lines in 34 cantos, and its
    shape is not decoration: a citation is a canto and a line number
    (Inf. V.121), the tercet is the unit Dante thought in, and the line
    counts (136, 142, 136, 151, ...) are facts about the poem rather
