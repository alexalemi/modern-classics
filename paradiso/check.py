"""Per-book checks for paradiso/ — the euclid-rivals pattern.
...
cannot see any of the following.
  ...
  1 VERSE INTEGRITY, and it is the decisive check for this book, exactly
    as in boethius/. The Paradiso is 4,758 lines in 33 cantos, and its
    shape is not decoration: a citation is a canto and a line number
    (Par. XXXIII.145), the tercet is the unit Dante thought in, and the line
    counts (142, 148, 130, 142, ...) are facts about the poem rather
