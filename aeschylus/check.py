"""Per-book checks for aeschylus/ -- sophocles/check.py with the cast changed.
...
that cannot fail a build will eventually be ignored.
    ...
    python3 aeschylus/check.py [NNN ...]
"""
import os
import re
import sys
...
SPEAKERS = {
    "Χορός": "Chorus", "Δαναός": "Danaus", "Βασιλεύς": "King",
    "Κῆρυξ": "Herald",
    # the exodos of The Suppliants splits the chorus in two and then into
    # single voices; the Greek names them, so the tags do too.
    "Χορός Δαναΐδων": "Danaids", "Χορὸς Θεραπαινῶν": "Serving Women",
    "Δαναΐς": "A Danaid", "Θεράπαινα": "A Serving Woman",
    # Aeschylus never names Xerxes' mother; "Atossa" is the editors'.
    "Ἄτοσσα": "Queen", "Ἄγγελος": "Messenger",
    # the ghost is Darius; one tag for one speaker, and the stage
    # direction says he rises from the tomb.
    "Εἴδωλον Δαρείου": "Darius", "Δαρεῖος": "Darius", "Ξέρξης": "Xerxes",
    "Κράτος": "Power", "Ἥφαιστος": "Hephaestus", "Προμηθεύς": "Prometheus",
    "Ὠκεανός": "Oceanus", "Ἰώ": "Io", "Ἑρμῆς": "Hermes",
    "Ἐτεοκλής": "Eteocles", "Ἀντιγόνη": "Antigone", "Ἰσμήνη": "Ismene",
    "Ἡμιχόριον Α": "First Half-Chorus", "Ἡμιχόριον Β": "Second Half-Chorus",
    "Φύλαξ": "Watchman", "Κλυταιμήστρα": "Clytemnestra",
    "Κλυταιμνήστρα": "Clytemnestra", "Ἀγαμέμνων": "Agamemnon",
    "Κασάνδρα": "Cassandra", "Αἴγισθος": "Aegisthus",
    "Ὀρέστης": "Orestes", "Ἠλέκτρα": "Electra", "Οἰκέτης": "Servant",
    "Τροφός": "Nurse", "Πυλάδης": "Pylades",
    "Πυθιάς": "Priestess", "Ἀπόλλων": "Apollo",
    "Κλυταιμήστρας Εἴδωλον": "Ghost of Clytemnestra", "Ἀθηνᾶ": "Athena",
    "Προπομποί": "Escort",
}
# Per-play overrides: in Seven Against Thebes the Ἄγγελος is the army's
# scout (kataskopos, 36-37), and Smyth tags him so.
SPEAKERS_BY_PLAY = {4: {"Ἄγγελος": "Scout"}}
