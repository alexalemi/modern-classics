"""Apply a proofreader's fixes to the OCR draft of a Helmholtz page.

    python3 helmholtz/apply_fixes.py 041 [042 ...]    # writes proof/NNN.txt
...
new page (a table page the OCR destroyed) may be given as a single block
