...
| The First Six Books of the Elements of Euclid (1847) | Oliver Byrne | DONE 2026-09-20, restored, CC BY-SA 4.0 (Alex's ruling: built on Sergey Slyusarev's LaTeX+MetaPost recreation). The recreation is typeset by LuaTeX and its own output read: a pre_linebreak_filter serialises every paragraph and each of the 6,115 MetaPost pictures is shipped out as its own page and kept as SVG (byrne/capture/). New shared inline-picture markup (assemble.GLYPHS) |
