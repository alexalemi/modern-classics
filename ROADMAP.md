...
### Working list, Alex, 2026-09-20 (both halves: restored editions, or a retelling where one is needed)

Kept as a working list, in the order given. The copyright column is a
FIRST READ, not a clearance: every title is checked against the Stanford
renewal database (and HathiTrust) before any work starts, as Rogers was.
...
| On the Sensations of Tone (Ellis tr. 1875/1885) | Helmholtz | UNDER WAY 2026-09-20 (Alex: go ahead, Anatomy deferred). Restored, page-read from onsensationsofto00helmrich (1895 reprint of Ellis's revised 2nd edition of 1885); witnesses onsensationston00unkngoog (1885) and onsensationston00elligoog (1895) |
...
| The Evolution of Physics (1938) | Einstein & Infeld | RULED OUT: renewed by Leopold Infeld 25 Oct 1965 (R372924, original A116236 of 28 Mar 1938), protected in the US to 2033. Found in NYPL's cce-renewals dataset (github.com/NYPL/cce-renewals, data/1965-1.tsv) while Stanford's search was bot-walled |
...
| The Tarbell Course in Magic (the 1926-28 correspondence lessons) | Harlan Tarbell | CHECK: the original mail-order lessons of 1926-28 are PD in the US if published then (1928 works entered the public domain in 2024); the later Tannen book volumes (1941 on) are NOT. Find a scan of the lessons themselves. Added by Alex 2026-09-20 NOT FOUND 2026-09-20: both Archive.org items dated 1927 are the later revised editions (Tannen's 1942 Vol. II; the Robbins/Read Vol. I), not the lessons. Looked on Archive.org only; HathiTrust and the magic-history collections (Conjuring Arts, Egyptian Hall) not yet searched |
| Rhetoric | Aristotle | DONE 2026-09-20, MODERN CLASSIC (rhetoric/): from Perseus' Greek (Ross's OCT) with Freese's 1926 Loeb as crib |
| Dimensional Analysis (1922) | P. W. Bridgman | DONE 2026-09-20, restored (bridgman/): every page read from the 1922 scan (dimensionalanaly00bridrich), 1,133 formulas typeset and each read twice, words voted against the Google and DLI copies |
| The First Six Books of the Elements of Euclid (1847) | Oliver Byrne | PAUSED 2026-09-20 after a prototype (see byrne/NOTES.txt: the diagrams regenerate exactly as SVG, but ~5,000 inline pictures inside formulas and proportion tables need a new rendering path; several days of engineering). ALEX'S RULING: build on Sergey Slyusarev's LaTeX + MetaPost recreation (github.com/jemmybutton/byrne-euclid; the book text CC BY-SA 4.0, the byrne.mp library GPLv3), so THIS EDITION CARRIES CC BY-SA 4.0 and credits it (the SICP precedent), not the public domain. Pictures: one mpost job per \defineNewPicture, every inline picture an SVG in source order; metafun (mpii) and MetaPost base fetched into byrne/_src/texmf since TeX Live here lacks luamplib/metafun |
