...
def resolve_all(part, text, inv, used, unresolved):
    ...
    return re.sub(r"(of this Part)(\s+of this Part)+", r"\1", joined)
...
BARE = re.compile(
    ...
    rf"(?:\s*(?:,|and)?\s*{_TAIL.format(n=_NUM)}\b\.?)*"
    rf"(?:\s+of this [Pp]art)?")
...
def resolve_bare(part, text, inv):
    ...
    return re.sub(r"(of this Part)(\s+of this Part)+", r"\1",
                  "".join(out))
...
def main():
    ...
    for n, text in parts:
        ...
        for k, g in enumerate(groups, 1):
            ...
            # legitimately.
            body = re.sub(r"(of this Part)(\s+of this Part)+",
                          r"\1", "\n\n".join(g))
